 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = sagenes * 2.1336 + arsnins * 0.7112 + vershoks * 0.04445
 ...
 */
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double = math.sqrt((x2 - x1) * (x2 - x1) + (y2 - y1) * (y2 - y1))
 ...
 */
fun thirdDigit(number: Int): Int = number.toString().reverse().get(2)
 ...
 */
fun numberRevert(number: Int): Int = number.toString().reverse()
